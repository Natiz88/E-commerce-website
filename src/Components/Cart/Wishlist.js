  ...
  return (
    <div className='listItems__container'>
        <div className="list__items">{
          ...
          <button onClick={() => dispatch(actions.removeFromList(product))}><RiDeleteBin6Fill className="heart" /></button>
          <button onClick={() => dispatch(actionTypes.addToCart(product.id))}>Add To Cart</button>
        </div>
        </div>
